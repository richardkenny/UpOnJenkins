...
jarsigner  -keypass password -storepass password -verbose -sigalg MD5withRSA -digestalg SHA1 -keystore autobuild/UpOnJenkins.keystore UpOnJenkins/bin/MainActivity-release-unsigned.apk mykey
