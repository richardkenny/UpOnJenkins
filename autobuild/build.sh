...
echo password | jarsigner -verbose -sigalg MD5withRSA -digestalg SHA1 -keystore autobuild/UpOnJenkins.keystore UpOnJenkins/bin/MainActivity-release-unsigned.apk -keypass password -storepass password
