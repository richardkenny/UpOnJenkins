...
jarsigner  -keypass password -storepass password -verbose -sigalg MD5withRSA -digestalg RSA -keystore autobuild/UpOnJenkins.keystore UpOnJenkins/bin/MainActivity-release-unsigned.apk mykey
